...
Ext.Require("SheetManager/Core/Classes/Types/SheetAbilityCategoryData.lua")
...
Ext.Require("SheetManager/Core/Classes/Base/SheetRaceData.lua")
...
Ext.Require("SheetManager/Core/Managers/SessionManager.lua")